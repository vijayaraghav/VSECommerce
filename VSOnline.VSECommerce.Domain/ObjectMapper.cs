...
namespace VSOnline.VSECommerce.Domain
{
    public class ObjectMapper
    {
        public void Execute()
        {
           ...
           Mapper.CreateMap<Product, ProductDTO>().ForSourceMember(x => x.ManufacturerDetails, t => t.Ignore());
           ...
           Mapper.CreateMap<Product, ProductModelForBranchCatalog>()
        .ForSourceMember(x => x.ManufacturerDetails, t => t.Ignore())
        .ForSourceMember(x => x.PricingCollection, t => t.Ignore())
        .ForSourceMember(x => x.CategoryDetails, t => t.Ignore())
        .ForSourceMember(x => x.ProductDescriptionHtml, t => t.Ignore())
        ...
        .ForMember(x => x.StoresCount, o => o.MapFrom(x => x.PricingCollection.Count()));
           ...
           Mapper.CreateMap<Product, ProductModelWithCategory>()
            // .ForSourceMember(x => x.ManufacturerDetails, t => t.Ignore())
             .ForSourceMember(x => x.PricingCollection, t => t.Ignore())
             .ForSourceMember(x => x.CategoryDetails, t => t.Ignore())
           ...
           Mapper.CreateMap<Product, ProductDetailModel>()
               .ForSourceMember(x => x.ManufacturerDetails, t => t.Ignore())
           ...
           Mapper.CreateMap<Pricing, RetailerPricingModel>()
           ...
           Mapper.CreateMap<SellerBranch, RetailerLocationMapDTO>()
           ...
           Mapper.CreateMap<ProductSpecification, ProductSpecificationResultSet>()
               .ForSourceMember(x => x.DisplayOrder, t => t.Ignore());

           Mapper.CreateMap<ProductFilterValue, ProductFilterValueResultSet>()
