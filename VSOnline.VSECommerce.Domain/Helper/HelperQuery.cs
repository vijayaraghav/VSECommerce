...
namespace VSOnline.VSECommerce.Domain.Helper
{
    public class HelperQuery
    {
        public string GenerateFilterTempTable(List<VSOnline.VSECommerce.Domain.ResultSet.SelectedProductFilterList> filters)
        {
            ...
            //{
            //    queryBuilder.Append("Select '{FilterParameter}' SelectedProductFilter, '{FilterValueText}' SelectedProductFilterValue".FormatWith(new {
            //        FilterParameter = filter.FilterParameter,
            //        FilterValueText = filter.FilterValueText
            //    }));
            //    queryBuilder.Append(" UNION ");
            //}//Fast hac.. sorry not thinking anything now...
