...
namespace VSOnline.VSECommerce.Web.Controllers
{
    ...
    {      
        ...
        public bool RemoveCache()
        {
            try
            {
                //_cacheManager.Remove(Enums.MAIN_MENU_CACHE_KEY);
                //_cacheManager.Remove(Enums.SiteSettings_CACHE_KEY);
                //_cacheManager.Remove(Enums.Home_TopProductList1_CACHE_KEY);
                //_cacheManager.Remove(Enums.Home_TopProductList2_CACHE_KEY);
                _cacheManager.Clear();
                return true;
            }
            catch
