...
namespace VSOnline.VSECommerce.Web.Controllers
{
    public class ProductsController : APIBaseController
    {
        ...
        //names may be confusing. but i am not willing to change now .. thats left for developers later for them to get better in coding. 
        [HttpPost]
        ...
        public List<ProductModelWithCategory> GetOffers(decimal lat, decimal lng, int radius, int limit)
        {
          ...
          //  return _unitOfWork.ProductRepository.GetOffers(branchIdListLocation, limit);
        }
        ...
        public List<ProductModelWithCategory> GetAllOffers(decimal lat, decimal lng, int radius)
        {
            ...
            return _unitOfWork.ExecuteQuery<ProductModelWithCategory>(offersquery);
           // return _unitOfWork.ProductRepository.GetOffers(branchIdListLocation,0);
        }
        ...
        public List<ProductFilter> GetFiltersForProductCategory(int id)
        {
            ...
            //TODO:We need to implement caching for this, to avoid any slowness in getting data and reduce DB hits. 
            return filterList;
        }
