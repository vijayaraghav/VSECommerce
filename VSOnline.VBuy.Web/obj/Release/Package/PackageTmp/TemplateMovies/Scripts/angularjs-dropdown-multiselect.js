    ...
    function ($filter, $document, $compile, $parse) {
        ...
        return {
            ...
            template: function (element, attrs) {
                ...
                template += '<button type="button" class="dropdown-toggle multiselectbuttonwidth" ng-class="settings.buttonClasses" ng-click="toggleDropdown()"><div class="multiselecttextwidth">{{getButtonText()}}</div><div class="fa fa-lg fa-angle-down multiselectarrow btnalignRight"></div></button>';
                template += '<ul class="dropdown-menu-vsecommerce dropdown-menu-form multiselectscroll" ng-style="{display: open ? \'block\' : \'none\', height : settings.scrollable ? settings.scrollableHeight : \'auto\' }">';
